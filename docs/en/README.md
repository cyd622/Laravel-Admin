...
First, install Laravel5.4, and make sure that the database connection settings are correct.

```
only surport Laravel 5.4
...
add `config/filesystems.php`  disks item follow code
```
